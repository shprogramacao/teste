...
NOTE: Version 20 of this package requires Angular 20 as a dependency. If you are using an older version of Angular, please install the relevant version e.g. 2.0.1 for Angular 2:
